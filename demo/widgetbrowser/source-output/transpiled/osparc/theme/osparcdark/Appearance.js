    ...
    appearances: {
      ...
      */
      ...
      "menu-checkbox": {
        ...
        style: function style(states) {
          return {
            icon: !states.checked ? undefined : osparc.theme.osparcdark.Image.URLS["menu-checkbox" + (states.selected ? "-invert" : "")]
          };
        }
      },
      ...
      "menu-radiobutton": {
        ...
        style: function style(states) {
          return {
            icon: !states.checked ? undefined : osparc.theme.osparcdark.Image.URLS["menu-radiobutton" + (states.selected ? "-invert" : "")]
          };
        }
      },
